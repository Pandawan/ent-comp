/**
 * Internal definition where required arguments are already set
 */
interface Component {
    /**
 ...
 */
declare type StateAccessor = (entID: number) => StateWithID | StateWithID[] | undefined;
/**
 * A `hasComponent`-like accessor function bound to a given component name.
 * @param entID the id of the entity to get from.
 * @returns True if that entity has that component.
 */
declare type ComponentAccessor = (entID: number) => boolean;
export default class ECS {
    /**
     * Hash of component definitions
     *
     * @example
     * var comp = { name: 'foo' }
